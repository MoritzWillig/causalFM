...
dataset_labels = ["Alitude", "Health", "Driving", "Recovery", "Cancer", "Earthquake"]
...
for api_idx, api in enumerate(from_apis):
    for template_idx, template in enumerate(question_templates):
        ...
        for dataset_idx, dataset in enumerate(datasets):
            ...
            plot_from_adj_mat(adj_mat, variable_names, dataset, ax=ax, abrev_vars=True, ignore_undefined=True)
